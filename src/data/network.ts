...
export const COMPANY_HUBS: CompanyHub[] = [
  { id: 'cloudflare', name: 'Cloudflare', lat: 37.34, lng: -121.89, logoPath: '/asset/cloudflare.svg', markerColor: '#f38020', note: 'Edge network and CDN hub', focus: 'Edge and security network', visitorFact: 'Cloudflare helps websites stay fast and protected by serving content from many nearby edge locations.' },
  { id: 'google-cloud', name: 'Google Cloud', lat: 1.35, lng: 103.82, logoPath: '/asset/google-cloud.svg', markerColor: '#4285f4', note: 'Global cloud backbone hub', focus: 'Hyperscale cloud platform', visitorFact: 'Google Cloud runs a private global backbone that moves app and video data between regions.' },
  { id: 'microsoft-azure', name: 'Microsoft Azure', lat: 53.35, lng: -6.26, logoPath: '/asset/azure.svg', markerColor: '#0078d4', note: 'Global cloud region hub', focus: 'Enterprise cloud platform', visitorFact: 'Azure powers many business services and keeps traffic close to users with many global regions.' },
  { id: 'aws', name: 'AWS', lat: 39.04, lng: -77.49, logoPath: '/asset/aws.svg', markerColor: '#ff9900', note: 'Hyperscale cloud region hub', focus: 'Largest cloud infrastructure footprint', visitorFact: 'AWS runs one of the biggest cloud footprints, so many apps you use every day pass through AWS regions.' },
  { id: 'meta', name: 'Meta', lat: 41.88, lng: -87.63, logoPath: '/asset/meta.svg', markerColor: '#0668e1', note: 'Private backbone traffic hub', focus: 'Social platform private backbone', visitorFact: 'Meta builds private long-distance links so messages, photos, and videos travel quickly between continents.' },
  { id: 'akamai', name: 'Akamai', lat: 42.36, lng: -71.06, logoPath: '/asset/akamai.svg', markerColor: '#d71920', note: 'CDN edge delivery hub', focus: 'Global content delivery network', visitorFact: 'Akamai places copies of content closer to users, so pages and streams load faster.' },
  { id: 'fastly', name: 'Fastly', lat: 37.77, lng: -122.42, logoPath: '/asset/fastly.svg', markerColor: '#ff282d', note: 'Edge cloud and CDN hub', focus: 'Real-time edge delivery', visitorFact: 'Fastly routes traffic through edge locations to reduce waiting time for dynamic websites and APIs.' },
  { id: 'oracle-cloud', name: 'Oracle Cloud', lat: 33.45, lng: -112.07, logoPath: '/asset/oracle-cloud.svg', markerColor: '#f80000', note: 'Cloud infrastructure hub', focus: 'Cloud for data-heavy systems', visitorFact: 'Oracle Cloud supports many data-heavy business systems and keeps copies of services in multiple regions.' },
  { id: 'alibaba-cloud', name: 'Alibaba Cloud', lat: 31.23, lng: 121.47, logoPath: '/asset/alibaba-cloud.svg', markerColor: '#ff6a00', note: 'Cloud backbone hub in Asia', focus: 'Cloud platform with strong Asia reach', visitorFact: 'Alibaba Cloud carries large traffic across Asia and supports many online shopping and payment services.' },
  { id: 'tencent-cloud', name: 'Tencent Cloud', lat: 22.32, lng: 114.17, logoPath: '/asset/tencent-cloud.svg', markerColor: '#0052d9', note: 'Cloud and gaming traffic hub', focus: 'Cloud platform and media delivery', visitorFact: 'Tencent Cloud supports game, chat, and media platforms that need stable low-delay routing.' },
  { id: 'equinix', name: 'Equinix', lat: 52.37, lng: 4.90, logoPath: '/asset/equinix.svg', markerColor: '#ed174f', note: 'Data center and IX interconnect hub', focus: 'Carrier-neutral data center campuses', visitorFact: 'Equinix is a meeting place where many networks connect directly, which reduces travel distance for data.' },
  { id: 'digital-realty', name: 'Digital Realty', lat: 32.78, lng: -96.80, logoPath: '/asset/digital-realty.svg', markerColor: '#00843d', note: 'Carrier-neutral data center hub', focus: 'Large colocation platform', visitorFact: 'Digital Realty hosts many internet providers and cloud systems in shared facilities.' },
  { id: 'ntt-communications', name: 'NTT Communications', lat: 35.68, lng: 139.69, logoPath: '/asset/ntt-communications.svg', markerColor: '#0033a0', note: 'Tier-1 backbone and data center hub', focus: 'Global backbone and enterprise network', visitorFact: 'NTT links major regions with long-distance fiber and large exchange points.' },
  { id: 'lumen', name: 'Lumen', lat: 39.74, lng: -104.99, logoPath: '/asset/lumen.svg', markerColor: '#5f259f', note: 'Long-haul backbone hub', focus: 'High-capacity long-distance fiber', visitorFact: 'Lumen moves large traffic volumes across metro and cross-country fiber routes.' },
  { id: 'deutsche-telekom', name: 'Deutsche Telekom', lat: 50.11, lng: 8.68, logoPath: '/asset/deutsche-telekom.svg', markerColor: '#e20074', note: 'European backbone hub', focus: 'European telecom backbone', visitorFact: 'Deutsche Telekom helps route massive traffic within Europe through major interconnect cities.' },
  { id: 'arelion', name: 'Arelion', lat: 59.33, lng: 18.07, logoPath: '/asset/arelion.svg', markerColor: '#14a3ff', note: 'Global Tier-1 transit hub', focus: 'Internet transit backbone provider', visitorFact: 'Arelion connects networks that need direct global transit across continents.' },
  { id: 'zayo', name: 'Zayo', lat: 41.88, lng: -87.63, logoPath: '/asset/zayo.svg', markerColor: '#0077c8', note: 'Metro and long-haul fiber hub', focus: 'Dense metro and long-haul fiber', visitorFact: 'Zayo links data centers and mobile networks with high-capacity fiber corridors.' },
  { id: 'starlink', name: 'Starlink', lat: 34.05, lng: -118.24, logoPath: '/asset/starlink.svg', markerColor: '#94a3b8', note: 'Satellite gateway network hub', focus: 'Low-orbit satellite internet gateway', visitorFact: 'Starlink connects satellites to ground gateways so internet can reach remote places.' },
];
